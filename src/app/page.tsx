        ...
        <div className="container-custom relative z-10">
          ...
          >
            <motion.div
              ...
              className="mb-8"
            >
              <span className="inline-block px-4 py-2 bg-primary-orange/10 border border-primary-orange/20 rounded-full text-primary-orange text-sm font-medium tracking-wide">
                TECH-FIRST GROWTH STUDIO
              </span>
            </motion.div>

            <motion.h1
              className="font-display text-6xl lg:text-8xl font-bold text-white mb-8 leading-tight"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.8 }}
            >
              Transforming Digital Identities
              <span className="block text-zinc-400 mt-2">into Legacies.</span>
            </motion.h1>

            <motion.p
              className="text-xl lg:text-2xl text-zinc-300 mb-16 max-w-4xl mx-auto leading-relaxed font-light"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Button asChild size="lg" className="text-lg px-10 py-4 group" aria-label="Scale your brand — contact M Square">
                <Link href="/contact">
                  Scale Your Brand
